...
import SideBarIcon1 from './images/Group 211.png';
import SideBarIcon2 from './images/SideBarIcon2.png';
import SideBarIcon3 from './images/material-symbols_post-add-rounded.png';
import SideBarIcon4 from './images/SideBarIcon4.png';
import SideBarIcon5 from './images/SideBarIcon5.png';
import SideBarIcon6 from './images/grommet-icons_transaction.png';
...
export default function HomePage() {
    ...
    setTimeout(() => {
        ...
        if (window.innerWidth >= 500) {
            ...
            document.getElementById("SideBarIcon2ID").style.top = "20px";
            document.getElementById("SideBarDivider").style.display = "block";
            document.getElementById("SideBarIconID").style.display = "block";
            document.getElementById("SideBarIconID2").style.display = "block";
            document.getElementById("SideBarIconID3").style.display = "block";
            document.getElementById("SideBarIconID4").style.display = "block";
            document.getElementById("SideBarIconID5").style.display = "block";
        }
        else
            if (window.innerWidth <= 500) {
                document.getElementById("SideBar").style.height = "50px";
                document.getElementById("SideBarIcon2ID").style.top = "0px";
                document.getElementById("SideBarDivider").style.display = "none";
                document.getElementById("SideBarIconID").style.display = "none";
                document.getElementById("SideBarIconID2").style.display = "none";
                document.getElementById("SideBarIconID3").style.display = "none";
                document.getElementById("SideBarIconID4").style.display = "none";
                document.getElementById("SideBarIconID5").style.display = "none";
            }
    }, 100);

    window.addEventListener("resize", () => {
        if (document.getElementById("SideBarSlider").style.display !== "block") {
            if (window.innerWidth >= 500) {
                document.getElementById("SideBar").style.height = "400px";
                document.getElementById("SideBarIcon2ID").style.top = "20px";
                document.getElementById("SideBarDivider").style.display = "block";
    ...
    const SliderOutBar = () => {
        if (Clicked == "False") {
            ...
            document.getElementById("SideBarSlider").style.display = "block";
            Clicked = "True";
        }
        else
            if (Clicked == "True") {
                ...
                document.getElementById("SideBarSlider").style.display = "none";
                Clicked = "False";
            }
    }
            ...
            <div id="HomePageCont">
                <div id="TopBar">
                    ...
                    <div id="TopSideBarMain">
                        <img id="TopSiderbarIconID" className="TopSideBarIcon" alt="TopSideBarIcon" src={SideBarIcon1} onClick={TopSliderOutBar} />
                    </div>
                    <div id="TopBarSec2">
                        <span id="Loca2">Location</span>
                        <span id="Serve2">Services</span>
                ...
                <div id="Frames">
                    <div id="Frame1">
                        ...
                        <div id="SideBar">
                            <img id="SideBarIcon2ID" className="SideBarIcon2" alt="SideBarIcon1" src={SideBarIcon1} onClick={SliderOutBar} />
                            <hr id="SideBarDivider" />
                            <img id="SideBarIconID" className="SideBarIcon" alt="SideBarIcon2" src={SideBarIcon2} />
                            <img id="SideBarIconID2" className="SideBarIcon" alt="SideBarIcon3" src={SideBarIcon3} />
                            <img id="SideBarIconID3" className="SideBarIcon" alt="SideBarIcon4" src={SideBarIcon4} />
                            <img id="SideBarIconID4" className="SideBarIcon" alt="SideBarIcon5" src={SideBarIcon5} />
                            <img id="SideBarIconID5" className="SideBarIcon" alt="SideBarIcon6" src={SideBarIcon6} />
                        </div>


                        <div id="SideBarSlider">
                            <div id="SideBar2">
                                <span id="Profile"><img className="ProfilePic" alt="ProfilePic" src={ProfilePic} /><span>Daniel Praise<br />
                                    <div id="ProfileExtras"><span>Lorem Ipsum</span><br /><span>#650.00</span>
                                    </div>
                                </span></span>
                                <hr id="SideBarDivider2" />
                                <span className="SideBarText1">Become a Gofer</span>
                                <span className="SideBarText2">Post A Job</span>
                                <span className="SideBarText3">Messages</span>
                                <span className="SideBarText4">Pay Bills</span>
                                <span className="SideBarText5">Transaction History</span>
                            </div>
                        </div>
                        <div id="Frame1Modal">
                    ...
                    <div id="Frame6">
                        ...
                        <div id="F6FinalMainCont">
                            <div id="F6FinalCont1">
                                ...
                                <span>Powered by FindGofer</span>
                            </div>
                            <div id="F6FinalCont2">
